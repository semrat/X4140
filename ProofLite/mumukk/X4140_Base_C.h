...
#ifndef X4140_Base_C_h
#define X4140_Base_C_h
...
class X4140_Base_C : public TSelector {
public :
   ...
   X4140_Base_C(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~X4140_Base_C() { }
  ...
  //  int muonQual[4] = {1,3,4,12};
   ...
   ClassDef(X4140_Base_C,0);
};

#endif

#ifdef X4140_Base_C_cxx
void X4140_Base_C::Init(TTree *tree)
{
