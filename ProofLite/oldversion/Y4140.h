...
public :
  ...
  ////////////////// SEMRA added //////////////////
  TH1F *Hist_Muon1_pt, *Hist_Muon1_Eta, *Hist_Muon1_Phi, *Hist_Muon2_pt, *Hist_Muon2_Eta, *Hist_Muon2_Phi; /// refit muons & kaons
  TH2F *Hist_Muon1PtvsMuon2Pt;
  TH1F *Hist_Kaon1_pt, *Hist_Kaon1_Eta, *Hist_Kaon1_Phi, *Hist_Kaon2_pt, *Hist_Kaon2_Eta, *Hist_Kaon2_Phi;
  TH2F *Hist_Kaon1PtvsKaon2Pt;
  TH1F *Hist_mumu_mass, *Hist_mumu_pt, *Hist_mumu_Eta, *Hist_mumu_Phi; /// muon pairs from original muons
  TH1F *Hist_kk_mass, *Hist_kk_pt, *Hist_kk_Eta, *Hist_kk_Phi;
  TH1F *Hist_JPsi_mass, *Hist_JPsi_pt, *Hist_JPsi_Eta, *Hist_JPsi_Phi;
  TH2F *Hist_JPsi_PtvsEta;
  TH1F *Hist_Phi_mass, *Hist_Phi_pt, *Hist_Phi_Eta, *Hist_Phi_Phi;
  TH2F *Hist_Phi_PtvsEta;

  TH1F *Hist_Bs0_Y_mass_fromNTuple, *Hist_Bs0_Y_mass, *Hist_Bs0_Y_pt, *Hist_Bs0_Y_Eta, *Hist_Bs0_Y_Phi; /// Bs0_Y

  TH1F *Hist_CTau_CTauE_PV, *Hist_Lxy_LxyE_PV;
  TH2F *Hist_CTauVsLxy_PV;
  /*TH1F *Hist_CTau_CTauE_BS, *Hist_Lxy_LxyE_BS;
  TH2F *Hist_CTauVsLxy_BS;
  TH1F *Hist_CTau_CTauE_XLessPV, *Hist_Lxy_LxyE_XLessPV;
  TH2F *Hist_CTauVsLxy_XLessPV;
  TH1F *Hist_CTau_CTauE_PVCosAlpha, *Hist_Lxy_LxyE_PVCosAlpha;
  TH2F *Hist_CTauVsLxy_PVCosAlpha;
  TH1F *Hist_CTau_CTauE_PVCosAlpha3D, *Hist_Lxy_LxyE_PVCosAlpha3D;
  TH2F *Hist_CTauVsLxy_PVCosAlpha3D;
  TH1F *Hist_CTau_CTauE_XLessPVCosAlpha, *Hist_Lxy_LxyE_XLessPVCosAlpha;
  TH2F *Hist_CTauVsLxy_XLessPVCosAlpha;
  TH1F *Hist_CTau_CTauE_XLessPVCosAlpha3D, *Hist_Lxy_LxyE_XLessPVCosAlpha3D;
  TH2F *Hist_CTauVsLxy_XLessPVCosAlpha3D;*/

  TH1F *Hist_Y4140_mass, *Hist_Y4140_pt, *Hist_Y4140_Eta, *Hist_Y4140_Phi;
  TH2F *Hist_Y4140_PtvsEta;
  TH1F *Hist_Bs0_mass, *Hist_Bs0_pt, *Hist_Bs0_Eta, *Hist_Bs0_Phi;
  TH2F *Hist_Bs0_PtvsEta;

  TH1F *Hist_JPsi_mass_HLT, *Hist_Y4140_mass_HLT, *Hist_Bs0_mass_HLT;
  TH1F *Hist_JPsi_mass_SoftMu;

  TH1F *Hist_Y4140_mass_SoftMu, *Hist_Bs0_mass_SoftMu;
  TH2F *Hist_JPsi_PtvsEta_JPsi, *Hist_Phi_PtvsEta_JPsi;
  TH1F *Hist_Y4140_mass_JPsi;
  TH2F *Hist_Y4140_PtvsEta_JPsi;
  TH1F *Hist_Bs0_mass_JPsi;
  TH2F *Hist_Bs0_PtvsEta_JPsi;

  TH1F *Hist_Y4140_mass_Prompt, *Hist_Bs0_mass_Prompt;
  TH1F *Hist_Y4140_mass_Mixed, *Hist_Bs0_mass_Mixed;
  TH1F *Hist_Y4140_mass_NonPrompt, *Hist_Bs0_mass_NonPrompt;

  TH1F *Hist_Y4140_mass_Track, *Hist_Bs0_mass_Track;
  TH1F *Hist_Y4140_mass_TrackP, *Hist_Bs0_mass_TrackP;
  TH1F *Hist_Y4140_mass_TrackM, *Hist_Bs0_mass_TrackM;
  TH1F *Hist_Y4140_mass_TrackNP, *Hist_Bs0_mass_TrackNP;

  TH1F *Hist_Y4140_mass_Phi, *Hist_Bs0_mass_Phi;
  TH1F *Hist_Y4140_mass_PhiP, *Hist_Bs0_mass_PhiP;
  TH1F *Hist_Y4140_mass_PhiM, *Hist_Bs0_mass_PhiM;
  TH1F *Hist_Y4140_mass_PhiNP, *Hist_Bs0_mass_PhiNP;

  TH1F *Hist_Y4140_mass_Bs0, *Hist_Bs0_mass_Bs0;
  TH1F *Hist_Y4140_mass_Bs0P, *Hist_SC_JPsi_mass_Bs0P, *Hist_SC_Phi_mass_Bs0P;
  TH1F *Hist_Bs0_mass_Bs0P, *Hist_CC_JPsi_mass_Bs0P, *Hist_CC_Phi_mass_Bs0P;

  TH1F *Hist_Y4140_mass_Bs0M, *Hist_SC_JPsi_mass_Bs0M, *Hist_SC_Phi_mass_Bs0M;
  TH1F *Hist_Bs0_mass_Bs0M, *Hist_CC_JPsi_mass_Bs0M, *Hist_CC_Phi_mass_Bs0M;

  TH1F *Hist_Y4140_mass_Bs0NP, *Hist_SC_JPsi_mass_Bs0NP, *Hist_SC_Phi_mass_Bs0NP;
  TH1F *Hist_Bs0_mass_Bs0NP, *Hist_CC_JPsi_mass_Bs0NP, *Hist_CC_Phi_mass_Bs0NP;

  TH1F *Xmultiplicity, *nIndex,*psiIndex,*psiIndexNx;

  Double_t JPsi_mass;
  Double_t Phi_mass;
  Double_t Bs0_Low_Mass;
  Double_t Bs0_High_Mass;
  Double_t Y_High_Mass;
