...
void X4140_Base_C::Begin(TTree * /*tree*/)
{
...
void X4140_Base_C::SlaveBegin(TTree * /*tree*/)
{
  ...
  std::string outputString = "X4140_Base_C_Ref_NoQual_Side4-6_NP3.0_CW5.15-5.55_BinWise_XnP_C.root";
...
bool X4140_Base_C::Process(Long64_t entry)
{
  ...
  int X4140_Base_Cer = 0,jPsiMuMuCounter = 0, jPsis = 0;
...
void X4140_Base_C::SlaveTerminate()
{
