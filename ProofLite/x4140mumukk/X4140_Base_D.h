...
class X4140_Base : public TSelector {
public :
   ...
   X4140_Base(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~X4140_Base() { }
  ...
  //  int muonQual[4] = {1,3,4,12};
   ...
   ClassDef(X4140_Base,0);
};

#endif

#ifdef X4140_Base_cxx
void X4140_Base::Init(TTree *tree)
{
