...
void X4140_Base_D::Begin(TTree * /*tree*/)
{
...
void X4140_Base_D::SlaveBegin(TTree * /*tree*/)
{
  ...
  std::string outputString = "X4140_Base_D_Ref_NoQual_Side4-6_NP3.0_CW5.15-5.55_BinWise_XnP_D.root";
...
bool X4140_Base_D::Process(Long64_t entry)
{
  ...
  int X4140_Base_Der = 0,jPsiMuMuCounter = 0, jPsis = 0;
...
void X4140_Base_D::SlaveTerminate()
{
