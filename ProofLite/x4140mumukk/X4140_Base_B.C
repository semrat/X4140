...
void X4140_Base_B::Begin(TTree * /*tree*/)
{
...
void X4140_Base_B::SlaveBegin(TTree * /*tree*/)
{
  ...
  std::string outputString = "X4140_Base_B_Ref_NoQual_Side4-6_NP3.0_CW5.15-5.55_BinWise_XnP_B.root";
...
bool X4140_Base_B::Process(Long64_t entry)
{
  ...
  int X4140_Base_Ber = 0,jPsiMuMuCounter = 0, jPsis = 0;
...
void X4140_Base_B::SlaveTerminate()
{
