#ifndef HeavyFlavorAnalysis_FourOnia2MuMu_FourOnia2MuMuPAT_h
#define HeavyFlavorAnalysis_FourOnia2MuMu_FourOnia2MuMuPAT_h
...
class FourOnia2MuMuPAT : public edm::EDProducer {
 public:
  explicit FourOnia2MuMuPAT(const edm::ParameterSet&);
  ~FourOnia2MuMuPAT() override;
