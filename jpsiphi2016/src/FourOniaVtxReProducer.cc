...
FourOniaVtxReProducer::FourOniaVtxReProducer(const edm::Handle<reco::VertexCollection> &handle, const edm::Event &iEvent)
{
...
void
FourOniaVtxReProducer::configure(const edm::ParameterSet &iConfig)
{
    config_ = iConfig;
...
FourOniaVtxReProducer::makeVertices(const reco::TrackCollection &tracks,
