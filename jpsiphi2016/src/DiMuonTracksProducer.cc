#include "../interface/DiMuonTracksProducer.h"
#include "../interface/FourOniaVtxReProducer.h"


DiMuonTracksProducer::DiMuonTracksProducer(const edm::ParameterSet& iConfig):
phi_tracks_Label(consumes<pat::CompositeCandidateCollection>(iConfig.getParameter< edm::InputTag>("phitracks"))),
...
void DiMuonTracksProducer::produce(edm::Event& event, const edm::EventSetup& esetup){
  ...
  //std::cout<<"DiMuonTracksProducer inside"<<std::endl;
  ...
  event.getByToken(phi_tracks_Label,dimuonsPhi);
...
float DiMuonTracksProducer::Getdz(const pat::CompositeCandidate& c, const reco::Candidate::Point &p) {
...
void DiMuonTracksProducer::endJob(){
  std::cout << "###########################" << std::endl;
...
//
// UInt_t DiMuonTracksProducer::isTriggerMatched(const pat::CompositeCandidate *diMuon_cand) {
...
bool DiMuonTracksProducer::isOverlappedMuons(const pat::CompositeCandidate *phi,const pat::CompositeCandidate *jpsi) {
...
const pat::CompositeCandidate DiMuonTracksProducer::makeCandidate(const pat::CompositeCandidate& phi,
  ...
  DEFINE_FWK_MODULE(DiMuonTracksProducer);
