...
//
//
// class QuadMuonFilter : public edm::EDProducer {
//  public:
//   explicit QuadMuonFilter(const edm::ParameterSet&);
//   ~QuadMuonFilter() override {};
...
// };
//
// QuadMuonFilter::QuadMuonFilter(const edm::ParameterSet& iConfig):
//     thePhi_(consumes<pat::CompositeCandidateCollection>(iConfig.getParameter<edm::InputTag>("phiTag"))),
//     theJPsi_(consumes<pat::CompositeCandidateCollection>(iConfig.getParameter<edm::InputTag>("jpsiTag"))),
...
// }
//
// UInt_t QuadMuonFilter::isTriggerMatched(const pat::CompositeCandidate *diMuon_cand) {
...
// void QuadMuonFilter::produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
...
// DEFINE_FWK_MODULE(QuadMuonFilter);
