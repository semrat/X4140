...
trakCollection_(consumes<edm::View<pat::Muon>>(iConfig.getParameter<edm::InputTag>("tracks"))),
...
FourOnia2KKPAT::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  ...
  edm::Handle< View<pat::Muon> > thePATTrackHandle;
  ...
  for(View<pat::Muon>::const_iterator kTrack1 = thePATTrackHandle->begin();kTrack1 != thePATTrackHandle->end(); ++kTrack1 )
  {
    ...
    for(View<pat::Muon>::const_iterator kTrack2 = kTrack1+1; kTrack2 != thePATTrackHandle->end(); ++kTrack2 )
    {
