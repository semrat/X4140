#ifndef HeavyFlavorAnalysis_FourOnia2MuMu_interface_FourOniaVtxReProducer_h
#define HeavyFlavorAnalysis_FourOnia2MuMu_interface_FourOniaVtxReProducer_h
...
class FourOniaVtxReProducer {
    public:
        /// This is the real constructor to be used
        FourOniaVtxReProducer(const edm::Handle<reco::VertexCollection> &configFromOriginalVertexCollection, const edm::Event &iEvent ) ;
        /// This is only for testing
        FourOniaVtxReProducer(const edm::ParameterSet &configByHand) { configure(configByHand); }
