...
#ifndef _MuMuKKSlim_h
#define _MuMuKKSlim_h
...
class mumukk : public edm::EDAnalyzer {
public:
  explicit mumukk(const edm::ParameterSet&);
  ~mumukk();
...
// rsync -vut --existing interface/MuMuPiKPAT.h semrat@lxplus.cern.ch:/afs/cern.ch/user/s/semrat/scratch0/CMSSW_5_3_22/src/X4140/mumukk/interface/MuMuPiKPAT.h
